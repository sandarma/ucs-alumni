        ...
        <Row>
          <Col md={12} lg={8}>
            <div className="cause-details__content">
                ...
                <br/>Click <a href="https://userroll.com/heros-from-ucs">here</a> to donate. Funds raised by your generosity from this campaign will be distributed to only the CDM participants from University of Computer Science in terms of food, shelter, and allotted monthly amounts.
                ...
                <a href="https://userroll.com/heros-from-ucs" className="thm-btn dynamic-radius">
                    Donate Now
                </a>
                </div>
            </div>
