        ...
        <Row>
          <Col md={12} lg={8}>
            <div className="cause-details__content">
                ...
                <p><span style={{color: 'red', fontWeight: 'bold'}}>Make a difference!</span></p>
                ...
                <br/>Click <a href="https://www.userroll.com/site/register/t201jaf">here</a> to donate. Funds raised by your generosity from this campaign will be distributed to only the CDM participants from University of Computer Science in terms of food, shelter, and allotted monthly amounts.</p>
                <p><span style={{color: 'red', fontWeight: 'bold'}}>You can make a difference!</span></p>
                <p>In association with Burmese Community Development Collaboration (BCDC), the funds will be collecting through existing BCDC platform, and you will receive the payment confirmation email from BCDC.</p>
...
export default HeroFromUcsContent;
